    ...
    rl.question("Enter the index of the URL you want to test (0-6): ", function (
        ...
        rl.question(
            ...
            function (guidelineSelected) {
                ...
                httpSelected = parseInt(httpSelected);
                guidelineSelected = parseInt(guidelineSelected);
                ...
                var newPromise = new Promise((resolve, reject) => {
                    ...
                    var url = require("url");
                    sslChecker(url.parse(httpList[httpSelected]).hostname)
                        .then((result) => {
                            sslResult = result;
                            resolve(sslResult);
                        })
                    ...
                    console.error("Error in new promise: ", e);
                });
                newPromise
                    .then((message) => {
